  ...
  return (
    <div className="flex flex-col items-center justify-center px-4 py-16 text-center bg-gradient-to-b from-purple-50 to-white">
      <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6 max-w-4xl">
        Introducing <span className="text-purple-600">HIGHLIGHTS</span>: Your AI Agent for Video Marketing
      </h1>
      <p className="text-xl md:text-2xl text-gray-700 mb-8 max-w-2xl">
        Turn Your Existing Videos Into Revenue-Generating Assets
      </p>
      <p className="text-lg text-gray-600 mb-12 max-w-2xl">
        You've already paid for UGC, Influencer Marketing, and branded videos. Now extract every dollar of performance from it — no editors, no guesswork, just results.
      </p>
      <Button 
        size="lg"
